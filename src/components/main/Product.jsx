...
import { setAddItemToCart, setOpenCart } from "@/components/niggu/CartSlice";
...
const Product = ({ id, title, text, rating, price, img, specifications, features, includes }) => {
  ...
  return (
    <>
      <div
        ...
        onClick={handleOpenModal} // Open modal on product click
      >
        ...
        <div className="absolute bottom-1 left-1/2 transform -translate-x-1/2 flex justify-center w-full h-1/2">
          <Image
            src={img}
            height={150}
            width={150}
      ...
      {isModalOpen && (
        <Modal
          item={{ id, title, text, price, img, specifications, features, includes }}
